...
Contour.setup do |config|
  ...
  [
     {
       name: 'Sign In', display: 'not_signed_in', path: 'new_user_session_path', position: 'right', condition: 'true',
     ...
     },
     {
       ...
       links: [{ name: 'Profile', path: 'profile_path' },
               { divider: true },
